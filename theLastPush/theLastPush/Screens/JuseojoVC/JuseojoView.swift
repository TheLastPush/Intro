...
class JuseojoView: UIView {
	...
	let explainLabel: UILabel = {
		...
		let mediumFont: [NSAttributedString.Key: Any] = [.font: UIFont.ibmPlexSansKR(size: 14, weight: .medium)]
		let regularFont: [NSAttributedString.Key: Any] = [.font: UIFont.ibmPlexSansKR(size: 14)]
		let blueFont: [NSAttributedString.Key : Any] = [
			.font: UIFont.ibmPlexSansKR(size: 14),
